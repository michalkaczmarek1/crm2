                  ...
                  <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="my-menu">
                          <ul class="nav navbar-nav navbar-right">
                              <li><a href="#" class="dashboard-admin">Kokpit</a></li>
                              <li><a href="#" id='salesman'>Przedstawiciel handlowy</a></li>
                              <li><a href="#" id='client'>Klient</a></li>
                              <li><a href="#" class="sale-admin" id='sale-admin'>Sprzedaż</a></li>
                              <li><a href="#" class='marketing-admin'>Marketing</a></li>
